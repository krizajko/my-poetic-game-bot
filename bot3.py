...
- Bez navodnika
- Sva slovo veliko
- Tematski vezan za ključne riječi

SADRŽAJ:
- Kreiraj tačno jedan naslov igre.
- Kreiraj tačno 10 pitanja.
- Svako pitanje mora imati tačno 3 opcije.
- Opcije moraju biti stvarne riječi ili kratke fraze (emocije, geste ili izbori).
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
		"Dobrodošao u poetičnu igru izbora.\n\n"
		"Ovdje riječi postaju put, a izbori tišina između dva daha.\n\n"
