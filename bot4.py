...
async def handle_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if state == "WAITING_KEYWORDS":
        ...
        # trenutno sporočilo – čakanje
        loading_msg = await update.message.reply_text(
            "Tvoje riječi se pretvaraju u pitanja...\n"
            "Slušam tišinu između njih."
        )
        ...
        try:
            ...
            await loading_msg.edit_text("Došlo je do greške. Pokušaj ponovo.")
            return
        ...
        await update.message.reply_text(
            "Na osnovu tvojih riječi stvaram poetičnu igru od 10 pitanja.\n"
            "Odgovaraš brojevima 1, 2 ili 3.\n"
            "Ne postoji tačan ili pogrešan izbor."
        )
